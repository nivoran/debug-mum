...
<div class="app-container">
    ...
    <header class="app-header">
        ...
        <h1 class="titre-app">FrançaisBoost AI</h1>
        <p> Par AI&Dev Academy </p>
        ...
        <div class="top-section">
            ...
            <div class="text-management">
                <div class="bloc-texte">
                    ...
                    <p>Entrer un thème et <a href="#" onclick="generateText(); return false;" class="action-link">générer un texte avec l'IA</a></p>              </div>
                <div class="bloc-texte">
            ...
            <div id="module-redaction" class="module-content" style="display: none; margin-top: 20px; font-family: sans-serif;">
                ...
                <div class="actions-container" style="margin-bottom: 20px;">
                    <a href="#" onclick="corrigerRedaction(event)" style="display: inline-block; margin-right: 15px; color: #dc3545; font-weight: bold; text-decoration: none;font-siez:12px">🔍 Corriger les fautes</a>
            ...
            <div id="module-conversation" style="display:none;">
                ...
                <!--a href="#" class="action-link" onclick="ecouterUtilisateur(); return false;">🎤 Répondre</a-->

                <!--button onclick="demarrerConversation()">
                🎤 Démarrer la conversation
                </button>
                <div id="conversation"></div>
                <button onclick="ecouterUtilisateur()">
                🎤 Répondre
                </button>
            </div-->
...
function showModule(module){
    ...
    if(!generatedText){
        ...
        alert("Veuillez d'abord générer ou charger un texte.");
        return;
    }
