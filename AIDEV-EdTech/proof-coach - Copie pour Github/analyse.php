...
$sql="SELECT d.*,e.titre,e.enonce,e.solution_modele FROM demonstrations d JOIN exercices e ON d.exo_id=e.id ORDER BY d.id DESC LIMIT 1 ";
$stmt=$pdo->query($sql);
